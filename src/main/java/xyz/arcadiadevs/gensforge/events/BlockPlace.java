...
/**
 * The BlockPlace class provides functionality for handling the BlockPlaceEvent in GensForge.
...
public class BlockPlace implements Listener {
  ...
  public void onBlockPlace(BlockPlaceEvent event) {
    ...
    final FileConfiguration config = GensForge.getInstance().getConfig();
