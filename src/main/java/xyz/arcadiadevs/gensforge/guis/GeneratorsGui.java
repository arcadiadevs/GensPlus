...
import xyz.arcadiadevs.gensforge.guis.guilib.ItemBuilder;
...
/**
 * The GeneratorsGui class provides functionality for opening the generators GUI in GensForge.
...
public class GeneratorsGui {
  ...
  public static void open(Player player) {
    final var instance = GensForge.getInstance();
