...
/**
 * The SellUtil class provides utility methods for selling generator drops in GensForge.
  ...
  public static void sellAll(Player player) {
    ...
    for (int i = 0; i < player.getInventory().getSize(); i++) {
      ...
      if (firstLine.contains("Generator drop tier")) {
        ...
        final GeneratorsData generatorsData = GensForge.getInstance().getGeneratorsData();
    ...
    if (totalSellAmount > 0) {
      final Economy economy = GensForge.getInstance().getEcon();
