...
/**
 * The GeneratorsData class represents the data for generators in GensForge. It contains a list
...
public record GeneratorsData(@Getter List<Generator> generators) {
  ...
  /**
   * The Generator record represents a generator in GensForge. It contains various properties
