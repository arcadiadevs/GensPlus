package xyz.arcadiadevs.gensforge.tasks;
...
public class DataSaveTask extends BukkitRunnable {
  ...
  private final GensForge instance;

  /**
   * Constructs a new DataSaveTask with the given GensForge instance.
   *
   * @param instance The GensForge instance.
   */
  public DataSaveTask(GensForge instance) {
